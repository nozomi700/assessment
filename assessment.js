...
function removeAllChiledren(element){
...
assessmentButton.onclick = function() {
    ...
    removeAllChiledren(resultDivided);
    ...
    removeAllChiledren(tweetDivided);
 ...
 */
 function assessment(userName){
    ...
    for(let i = 0; i < userName.length; i++){
        sumOfCharCade += userName.charCodeAt(i);
    }

    let index = sumOfCharCade % answers.length;
